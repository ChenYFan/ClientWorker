...
export default {
	...
	head: [
		...
		[
			"link",
			{
				href: "https://npmm/lightgallery@2.3.0/css/lightgallery.css",
				rel: "stylesheet",
			},
		],
		...
		sidebar: [
			...
			},
			{
				...
				items: [
					...
					{
						text: "url重写/并发 | url replace/parallel",
						link: "/rule/replace",
					},
			...
			},
			{
				...
				items: [
					{
						text: "如何解决JSDelivr等cdn在境内加载缓慢问题",
						link: "/example/parallelcdn",
					},
					{ text: "WEBP兼容计划", link: "/example/autowebp" },
					{
						text: "如何自动更新配置和ClientWorker",
						link: "/example/autoupdate",
					},
