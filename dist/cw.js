        ...
        for (let transform_rule of catch_rule.transform_rules) {
            ...
            switch (transform_rule.searchin || "url") {
                case 'url':
                    ...
                    break
                case 'header':
                    _utils_cons_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"].d */ .Z.d(tReq.headers.get(transform_rule.searchkey))
...
const FetchEngine = {
                    ...
                    new Promise(async (res, rej) => {
                        ...
                        const instance = async () => {
                            ...
                            const nReq = _rebuild_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"].request */ .Z.request(req, {
                                headers: {
                                    Range: `bytes=${(()=>{
                                        return AllSize-i * chunkSize>=chunkSize?`${i * chunkSize}-${(i + 1) * chunkSize - 1}`:`${i * chunkSize}-${AllSize-31}`
                                    })()}`
                                },
                                url: req.url
                            })
    ...
    KFCThursdayVW50: async (reqs, config) => {
        _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`V我五十以解锁KFC疯狂星期四引擎`)
...
const rebuild = {
    request: (req, init) => {
        ...
        if(req.mode === 'navigate') {
            _cons_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"].e */ .Z.e(`You can't rebuild a POST method with body when it is a navigate request.ClientWorker will ignore it's body`)
        }
